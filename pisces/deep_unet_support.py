# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_deep_unet_support.ipynb.
...
# %% ../nbs/03_deep_unet_support.ipynb 4
import os
import sys
import site
import numpy as np
...
# %% ../nbs/03_deep_unet_support.ipynb 5
"""
...
# %% ../nbs/03_deep_unet_support.ipynb 6
FS = 32
CHANNELS = 2
DEPTH = 9
N_OUT = 2 ** (DEPTH + 1)
...
# %% ../nbs/03_deep_unet_support.ipynb 7
...
# %% ../nbs/03_deep_unet_support.ipynb 10
def pisces_setup():
    """Creates a saved Keras model used in the `MOResUNetPretrained` classifier
    This function gives self-contained code to take the saved `.h5` model weights from Mads Olsen's group and convert them to a saved Keras model. This makes it much more portable, since we aren't trying to train this model further.
