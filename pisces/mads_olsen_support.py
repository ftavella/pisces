# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/03_mads_olsen_support.ipynb.
...
# %% ../nbs/api/03_mads_olsen_support.ipynb 4
import os
import sys
import site
import numpy as np
...
# %% ../nbs/api/03_mads_olsen_support.ipynb 6
FS = 32
CHANNELS = 2
DEPTH = 9
N_OUT = 2 ** (DEPTH + 1)
...
# %% ../nbs/api/03_mads_olsen_support.ipynb 7
...
# %% ../nbs/api/03_mads_olsen_support.ipynb 10
def pisces_setup():
