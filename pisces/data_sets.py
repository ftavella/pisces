...
# %% auto 0
__all__ = ['LOG_LEVEL', 'SimplifiablePrefixTree', 'IdExtractor', 'DataSetObject', 'PSGType', 'ProcessedData']

# %% ../nbs/01_data_sets.ipynb 4
from pathlib import Path
from enum import Enum, auto
from typing import Dict, List, Tuple
from .models import ModelInputType, ModelOutputType
...
class ProcessedData:
    def __init__(self, 
                 ...
                 output_feature: str, # Which of the features in `data_set` is used to calculate labels
