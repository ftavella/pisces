...
# %% auto 0
__all__ = ['LOG_LEVEL', 'SimplifiablePrefixTree', 'IdExtractor', 'DataSetObject', 'PSGType', 'ModelInputType', 'ModelOutputType',
...
class ProcessedData:
    def __init__(self, 
                 data_set: DataSetObject,
                 input_features: List[str], # Feature or features used to calculate model's input
                 input_window_size: float, # Window size in seconds for the input data. Window will be centered around the time point for which the model is making a prediction
                 input_sampling_hz: float, # Sampling rate of the input data (1/s)
                 input_type: ModelInputType, # Format of the data received by the model
                 output_type: ModelOutputType, # Format of the output expected by the model
                 output_feature: str='psg', # Which of the features in `data_set` is used to calculate labels. Default is 'psg'
                 ):
        # Currently developing support for one dimensional input type
        self.data_set = data_set
        self.input_features = input_features
        self.input_window_size = input_window_size
        self.input_sampling_hz = input_sampling_hz # Probably has to be multiple of 30 s
    ...
    def get_X_for_feature(self, interpolation_timestamps: np.ndarray,
    ...
    def get_X_y(self, id: str) -> Tuple[np.ndarray, np.ndarray] | None:
        ...
        for feature in self.input_features:
            ...
            if feature == 'accelerometer':
                ...
                for i in range(1, 4):
                    ...
                    X_feature = self.get_X_for_feature(interpolation_timestamps, 
